...
>
    <section class="main-card">
        ...
        <div class="right-panel">
            ...
            <form method="POST" action="{{ route('checkout.process', $transaction->uuid) }}" id="checkout-form">
                @csrf
                <input type="hidden" name="payment_method" value="credit_card">

                <div class="form-group">
                    <label class="form-label" x-text="cfg.emailLabel"></label>
                    <input type="email" name="email" class="form-input" value="{{ $transaction->customer_email ?? '' }}" x-bind:placeholder="country === 'US' ? 'your@email.com' : 'seu@email.com'" required>
