...
{
    public function createCustomer(array $data): array { return ['id' => 'PAYPAL_' . uniqid()]; }
    public function createPayment(array $data): array { return ['id' => 'PAY_' . uniqid(), 'status' => 'APPROVED']; }
