...
/**
 * Validação para pagamento via boleto bancário.
 *
 * [Fase 3.3] Request segregada por método de pagamento.
 * Espera customerData com name, email, document, cep, address.
 */
class ProcessBoletoPaymentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'customerData.cep'      => 'nullable|string',
            'customerData.address'  => 'nullable|string',
